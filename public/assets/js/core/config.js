...
const DISABLED_MODULES = new Set(['materiais', 'equipamentos']);
...
const modules = {
  ...
  pedidos: { name: 'Solicitação de Materiais', icon: '◫', fields: [['item', 'Material', 'MATERIAL_ITEM'], ['categoria', 'Categoria', 'MATERIAL_CATEGORY'], ['quantidade', 'Quantidade', 'MATERIAL_QUANTITY'], ['setor', 'Setor solicitante', 'MATERIAL_SECTOR'], ['solicitante', 'Solicitante', 'MATERIAL_REQUESTER'], ['status', 'Status', 'MATERIAL_STATUS'], ['observacoes', 'Observação', 'OPTIONAL_TEXTAREA']] },
...
const MATERIAL_CATALOG = { Bobinas: ['Bobina — Totem', 'Bobina — Maquininha', 'Bobina — Painel'], Papelaria: ['Lápis', 'Papel A4', 'Materiais diversos'], Periféricos: ['Teclado', 'Mouse'] };
const MATERIAL_STATUSES = ['Solicitado', 'Em atendimento', 'Entregue'];
const moduleFilters = {
  pedidos: [['categoria', 'Categoria'], ['status', 'Status'], ['setor', 'Setor']],
