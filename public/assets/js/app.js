...
function demandReportFold(title, content, description = 'Clique para visualizar') { return `<details class="demand-report-fold"><summary><span>${esc(title)}<small>${esc(description)}</small></span><b aria-hidden="true">⌄</b></summary>${content}</details>`; }
